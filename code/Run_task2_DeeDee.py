...
params: Parameters = Parameters(2,"deedee")
...
# params.path_annotations = os.path.join('..','validare','task2_deedee_gt_validare20.txt')

params.dir_test_examples = os.path.join('..','evaluare','fake_test')
params.path_annotations = os.path.join('..','validare','task2_deedee_gt_validare.txt')
...
params.number_positive_examples = 2488
params.number_negative_examples = 49138
params.number_hard_mining = 27474
...
#0.512
ratios = [0.4, 0.5, 0.6, 0.65, 0.7,0.75, 0.8, 0.9, 1]
nr_of_resizing = 20
...
##########################hard_mining
# character = "deedee"
# output_csv_path = os.path.join('..','antrenare',f"task2_{character}_hard_mining")
...
# output_csv_path = os.path.join('..','antrenare',f"task2_{character}_hard_mining","dad.csv")
...
# output_csv_path = os.path.join('..','antrenare',f"task2_{character}_hard_mining","mom.csv")
...
# output_csv_path = os.path.join('..','antrenare',f"task2_{character}_hard_mining","dexter.csv")
