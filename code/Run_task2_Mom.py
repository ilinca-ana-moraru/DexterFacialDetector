...
params: Parameters = Parameters(2,"mom")
...
# params.path_annotations = os.path.join('..','validare','task2_mom_gt_validare20.txt')

# params.dir_test_examples = os.path.join('..','evaluare','fake_test')
# params.path_annotations = os.path.join('..','validare','task2_mom_gt_validare.txt')
...
params.number_positive_examples = 2066
params.number_negative_examples = 49560
params.number_hard_mining = 20647
...
# output_csv_path = os.path.join('..','antrenare',"task2_mom_hard_mining","dad.csv")
...
# output_csv_path = os.path.join('..','antrenare',"task2_mom_hard_mining","mom.csv")
...
# output_csv_path = os.path.join('..','antrenare',"task2_mom_hard_mining","dexter.csv")
...
# output_csv_path = os.path.join('..','antrenare',"task2_mom_hard_mining","deedee.csv")
